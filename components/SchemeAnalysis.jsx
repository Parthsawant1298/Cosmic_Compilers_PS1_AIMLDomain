        ...
        <div className="py-2 px-4 bg-black text-white">
          <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center text-xs sm:text-sm gap-2 sm:gap-0">
            ...
            <div className="text-center sm:text-right">
              <span>SafeCity Protocol Initiative</span>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            AI-Powered Scheme Analysis & Incident Matching
          </h1>
          <p className="text-lg text-gray-600">
            Upload government scheme PDFs to automatically extract eligibility criteria and match with incidents
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <input
                ...
                placeholder="Enter scheme name (e.g., Safe City 2024)"
            ...
            <div className="text-center py-4">
              <div className="inline-flex items-center">
                ...
                <span className="text-blue-600 font-medium">
                  Analyzing PDF and matching incidents...
                </span>
              </div>
            </div>
          )}
        ...
        {uploadResults && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            ...
            {uploadResults.matched_claimants && uploadResults.matched_claimants.length > 0 && (
              <div className="mt-4">
                <h4 className="font-medium text-gray-700 mb-2">Top Matched Incidents (Preview)</h4>
                ...
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <YAxis />
                      <Tooltip
                        formatter={(value, name) => [value, name === 'eligible_claimants' ? 'Eligible Incidents' : 'Avg Score']}
              ...
              {schemes.map((scheme) => (
                <div key={scheme._id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-600">Eligible Incidents</p>
                    ...
                    <div>
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${scheme.status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                        }`}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    >
                      ...
                      View Incidents ({scheme.total_applicable_claimants || 0})
                    </button>
              ...
              <div className="p-6 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-semibold">
                    Eligible Incidents for: {selectedScheme.name}
                  </h3>
                  <button
                    onClick={() => {
                ...
                <p className="text-gray-600 mt-1">Total: {schemeClaimants.length} eligible incidents</p>
              </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg max-w-7xl w-full max-h-[90vh] overflow-hidden">
              ...
              <div className="p-6 overflow-y-auto max-h-[70vh]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h4 className="font-medium text-blue-600">Total Incidents</h4>
                    <p className="text-2xl font-bold text-gray-800">{analytics.total_claimants}</p>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-medium text-green-600">Eligible Incidents</h4>
                    <p className="text-2xl font-bold text-gray-800">{analytics.eligible_claimants}</p>
                  </div>
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <h4 className="font-medium text-purple-600">Average Score</h4>
                    <p className="text-2xl font-bold text-gray-800">{analytics.average_score}/100</p>
                  </div>
                  <div className="bg-orange-50 p-4 rounded-lg">
                    <h4 className="font-medium text-orange-600">Ineligible Incidents</h4>
                    <p className="text-2xl font-bold text-gray-800">
                      {analytics.total_claimants - analytics.eligible_claimants}
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="bg-white border rounded-lg p-4 shadow-sm">
                    <h4 className="font-semibold text-gray-800 mb-4">District-wise Eligibility</h4>
                    <div className="h-64">
                      <ResponsiveContainer width="100%" height="100%">
                        <RechartsBarChart
                          data={analytics.district_stats}
                        ...
                        >
                          ...
                          <Tooltip />
                          <Legend />
                          <Bar dataKey="eligible" name="Eligible" fill="#10b981" />
